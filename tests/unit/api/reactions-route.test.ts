...
describe("POST /api/v1/skills/[id]/reactions rate limit", () => {
  it("should return rate limit response", async () => {
    ...
    const req = new NextRequest("http://localhost/api/v1/skills/s1/reactions", { method: "POST", body: JSON.stringify({ emoji: "HEART" }) });
...
describe("POST /api/v1/skills/[id]/reactions", () => {
  ...
  it("should handle all valid emojis", async () => {
    const validEmojis = ["THUMBS_UP", "THUMBS_DOWN", "LAUGH", "HOORAY", "CONFUSED", "HEART", "ROCKET", "EYES"];
