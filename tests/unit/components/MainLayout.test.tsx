...
vi.mock("@/components/layout/Sidebar", () => ({
  Sidebar: ({ isAdmin }: { isAdmin?: boolean }) =>
    React.createElement("div", { "data-testid": "sidebar" }, isAdmin ? "admin-sidebar" : "user-sidebar"),
}));

vi.mock("@/components/shared/SseProvider", () => ({
  SseProvider: ({ children, userId }: { children: React.ReactNode; userId?: string }) =>
    React.createElement("div", { "data-testid": "sse-provider", "data-userid": userId ?? "" }, children),
}));
