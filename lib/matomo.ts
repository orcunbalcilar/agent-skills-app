...
export const MATOMO_EVENTS = {
  skillDownloaded: (skillId: string) => trackEvent('skill', 'downloaded', skillId),
  skillReleased: (skillId: string) => trackEvent('skill', 'released', skillId),
  skillForked: (skillId: string) => trackEvent('skill', 'forked', skillId),
