// app/api/v1/skills/[id]/follow/route.ts
...
export async function POST(req: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    await pgNotify(`skill_followers:${id}`, JSON.stringify({ event: 'follow', followerCount }));
...
export async function DELETE(req: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    await pgNotify(`skill_followers:${id}`, JSON.stringify({ event: 'unfollow', followerCount }));
