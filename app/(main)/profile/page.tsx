...
export default function ProfilePage() {
  ...
  return (
    <div className="animate-fade-in space-y-8">
      <Card className="border-border/50 relative overflow-hidden">
        ...
        <CardHeader className="relative">
          <div className="flex items-center gap-4">
            <Avatar className="ring-primary/20 size-16 shadow-lg ring-2">
      ...
      <section>
        <h2 className="mb-4 text-xl font-semibold">Released Skills</h2>
        ...
        {released?.meta && released.meta.totalPages > 1 && (
          <Pagination
            page={releasedPage}
            totalPages={released.meta.totalPages}
      ...
      <section>
        ...
        {templates?.data.length === 0 && <p className="text-muted-foreground">No templates.</p>}
